      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <select value={symbol} onChange={(e) => setSymbol(e.target.value as "USDC" | "BTC")} className="w-full px-3 py-2 border border-gray-300 rounded-md">
          ...
          <div className="flex gap-3 pt-4">
            <button type="button" onClick={onClose} className="flex-1 px-4 py-2 text-gray-700 bg-gray-200 rounded-md hover:bg-gray-300 transition-colors cursor-pointer">
              Cancel
            </button>
            <button
              type="submit"
