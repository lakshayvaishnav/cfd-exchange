    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="max-w-md w-full mx-auto">
        <div className="text-center mb-2">
          ...
          <p className="text-sm md:text-md text-black mb-4 leading-relaxed font-ibm-plex-mono">Start your trading journey with limitless opportunities</p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-black font-dm-sans">
            ...
            <Link href="/login" className="font-medium hover:text-gray-700 transition-colors underline">
              Sign in
            </Link>
          </p>
        </div>
        ...
        <div className="mt-6 text-center">
          <Link href="/" className="text-sm text-black hover:text-gray-700 transition-colors font-dm-sans underline">
            ← Back to Home
          </Link>
        </div>

        <div className="mt-6 text-center">
          <p className="text-xs text-gray-600 font-dm-sans leading-relaxed">By creating an account, you agree to our Terms of Service and Privacy Policy</p>
        </div>
      </div>
    </div>
  );
