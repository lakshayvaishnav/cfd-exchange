    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="max-w-md w-full mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-sm md:text-md text-black mb-4 leading-relaxed font-ibm-plex-mono">Continue your trading journey with 100xness</p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-black font-dm-sans">
            ...
            <Link href="/register" className="font-medium hover:text-gray-700 transition-colors underline">
              Create one
            </Link>
          </p>
        </div>
